...
create table UPLOADFILE(
    uploadfile_id       number(10),     -- 파일 아이디
    code                varchar2(11),   -- 분류 코드
    rid                 number(10),     -- 참조 번호(게시글 번호 등)
    store_filename      varchar2(100),  -- 서버 보관 파일명
    upload_filename     varchar2(100),  -- 업로드 파일명(유저가 업로드한 파일명)
    fsize               varchar2(45),   -- 업로드 파일 크기(단위:byte)
    ftype               varchar2(100),  -- 파일 유형(mimetype)
