...
public class MemberController {
  ...
  public String join(
    ...
    //3) 유효성체크 - global 오류 (2개 이상의 필드체크, 백앤드로직 수행 시 발생하는 오류)
    //비밀번호 != 비빌번호체크
...
//  }
  ...
  //콤마를 구분자로 하는 문자열을 문자열 요소로갖는 리스트로 변환
  ...
  public String outCompleted(){
    ...
    return "member/outCompleted"; //탈퇴수행 완료 화면
  }
